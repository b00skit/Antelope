...
export const factions = table('factions', {
  ...
  feature_flags: json('feature_flags')
    .$type<{ activity_rosters_enabled?: boolean; character_sheets_enabled?: boolean; statistics_enabled?: boolean; units_divisions_enabled?: boolean; data_exports_enabled?: boolean; }>()
