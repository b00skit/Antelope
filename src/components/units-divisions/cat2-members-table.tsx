...
export function MembersTable({ members, allFactionMembers, canManage, cat1Id, cat2Id, onDataChange, allUnitsAndDetails, forumGroupId, isSecondary }: MembersTableProps) {
